...
global.owner = process.env.OWNER_NUMBER  || '5561999396472' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=7N10AAAQ#fv4dCmfoJv8sM8hr99EFINJSsEGHFanRN1HGpwF3Ozc' ,
